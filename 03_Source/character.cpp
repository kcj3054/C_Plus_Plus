...
void character::set_point(coordinate point) {
	point = point;
}
coordinate character::get_point() {
	return point;
}

void character::move(direction dir, int distance) {
	cout << '\n' << "Character Move" << '\n';
	cout << "============================" << '\n';
	cout << "캐릭터가 <<" << coordinate::get_direction_string(dir)  << " 방향으로 " << distance << " 만큼 " << " 걸어갔습니다." << '\n';
	cout << "============================" << '\n';
}
